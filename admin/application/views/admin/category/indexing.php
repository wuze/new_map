...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="7" background="skin/images/tbg.gif">&nbsp;索引信息分类列表&nbsp;</td>
</tr>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td><?php echo anchor('admin_login/category/add_indexing/'.$key->id,"添加子分类");?> | <?php echo anchor('admin_login/category/edit_indexing/'.$key->id,"修改");?>  <?php if(!$sub_cate_num){echo " | ".anchor('admin_login/category/del_indexing/'.$key->id,"删除","onclick =  \"return confirm('确定删除吗?')\"");}?></td>
</tr>
<?php foreach($key->sub_cate as $sencond_cate) {?>
	...
	<td><?php echo anchor('admin_login/category/edit_indexing/'.$sencond_cate->id,"修改");?> | <?php echo anchor('admin_login/category/del_indexing/'.$sencond_cate->id,"删除","onclick =  \"return confirm('确定删除吗?')\"");?></td>
</tr>
	<?php }?>
<?php }?>
