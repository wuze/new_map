...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td><?php echo anchor('admin_login/culture/edit_traditional/'.$key->id,"编辑");?> | <?php echo anchor('admin_login/culture/detail_traditional/'.$key->id,"详情");?>  <?php echo anchor('admin_login/culture/del_traditional/'.$key->id,"删除","onclick =  \"return confirm('删除将连详情的图片一并删除,确定删除吗?')\"");?></td>
</tr>
<?php }?>
